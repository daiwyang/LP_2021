...
As of 2024-10-15, this database contains:

* 2631 current era publications, 1682 of which are for data collection and 1023 are for data analysis (see Chapter 1 for definition of prequel and current eras)
* 281 prequel era publications
* Current era publications from 733 institutions[^1] in 396 cities in 43 countries
* 825 current era data analysis software packages whose source code is available online
